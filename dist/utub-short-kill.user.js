...
// @grant        none
// @downloadURL  https://raw.githubusercontent.com/WicktorB/YouTube-Short-Kill/main/dist/utub-short-kill.user.js
// @updateURL    https://raw.githubusercontent.com/WicktorB/YouTube-Short-Kill/main/dist/utub-short-kill.user.js
// ==/UserScript==
(() => {
...
`;
  ...
  function createUserscriptStorage() {
  ...
  if (window.top === window.self) {
    createApp(createUserscriptStorage()).init().catch(function() {
    });
  }
})();
